    ...
    <nav className="oh-navbar">
      <div className="oh-wrapper">
        ...
        <div className="oh-navbar__systray">
          {/* CLOCK-IN Button */}
          <a href="#" className="oh-navbar__clock">
            {getIonIcon('enter-outline', 'oh-navbar__clock-icon')}
            <span className="oh-navbar__clock-text">Check-In</span>
          </a>
          {/* CLOCK-OUT (commented out in original HTML) */}
          {/* <a href="#" class="oh-navbar__clock">
            {getIonIcon('exit-outline', 'oh-navbar__clock-icon me-2')}
