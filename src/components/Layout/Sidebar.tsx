...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div
      className={`oh-sidebar ${isCollapsed ? 'collapsed' : ''}`}
      style={{ position: 'fixed', top: 0, left: 0, height: '100vh', overflowX: 'hidden', width: isCollapsed ? '80px' : '280px', zIndex: 999 }}
    >
      <div className="oh-sidebar__company" style={{ padding: '14px' }}>
        {isCollapsed ? (
